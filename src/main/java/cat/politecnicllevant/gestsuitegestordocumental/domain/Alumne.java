...
public @Data class Alumne {
    ...
    @Column(name = "localitat_naixement", nullable = true, length = 128)
    ...
    @Column(name = "CP", nullable = true, length = 128)
    private String CP;

    @Column(name = "telefon", nullable = true, length = 128)
    private String telefon;

    @Column(name = "telefon_fix", nullable = true, length = 128)
    ...
    @Column(name = "telefon_tutor", nullable = true, length = 255)
    private String telefonTutor;

    @Column(name = "email_tutor", nullable = true, length = 255)
